...
def run(
    ...
    im = torch.zeros(batch_size, 6, *imgsz).to(device)  # image size(1,3,320,192) BCHW iDetection
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/home/linux531/WYX/yolov5-master/runs/train/exp3/weights/best.pt', help='model.pt path(s)')
