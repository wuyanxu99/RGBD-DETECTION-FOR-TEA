...
if __name__ == "__main__":
    onnx_path = '/home/linux531/ZJ/yolov5-master/yolov5-master/runs/train/exp15/weights/best.onnx'
    model = Yolov5ONNX(onnx_path)

    output, org_img = model.inference('/home/linux531/ZJ/yolov5-master/yolov5-master/data/images/0a2e5911657218e337421864ec8cfb905cd591cf54ec0c18e04bf763af90822d.jpg')
    print(output.shape)
